...
export const internTestimonials = [
  {
    theme: 'red',
    text: 'Clients opened up once we could meet them in Romanian and English. Clear communication turned tense meetings into real partnerships.',
    emphasis: 'real partnerships',
    name: 'Braxton',
    detail: 'Languages & public relations',
  },
  {
    theme: 'blue',
  ...
  {
    theme: 'red',
    text: 'We helped an owner sharpen how they talked about their business online and in person. Within weeks, customers were repeating their message back to them.',
    emphasis: 'repeating their message',
    name: 'Katya',
  ...
  {
    theme: 'ink',
    text: 'A spreadsheet full of sales history looked like noise until we charted it. The owner finally saw which products were carrying the shop.',
    emphasis: 'carrying the shop',
    name: 'Meg',
    detail: 'Data analytics',
  },
  {
    theme: 'red',
    text: 'We rebuilt their Instagram from scattered posts into a feed that actually matched the shop. Foot traffic picked up before the summer ended.',
    emphasis: 'Foot traffic',
    name: 'Halle',
    detail: 'Marketing & social media',
  },
  {
    theme: 'blue',
